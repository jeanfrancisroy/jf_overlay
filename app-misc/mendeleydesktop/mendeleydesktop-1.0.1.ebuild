...
QA_PRESTRIPPED="
	/opt/mendeleydesktop/$(get_libdir)/mendeleydesktop/libexec/mendeleydesktop.x86_64
	/opt/mendeleydesktop/$(get_libdir)/mendeleydesktop/libexec/Updater
	/opt/mendeleydesktop/$(get_libdir)/libPDFNetC.so
	/opt/mendeleydesktop/$(get_libdir)/libMendeley.so.${PV}"
