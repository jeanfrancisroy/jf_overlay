...
# $Header: /var/cvsroot/gentoo-x86/sys-cluster/openmpi/openmpi-1.6.2.ebuild,v 1.3 2012/10/16 18:43:05 jlec Exp $
...
src_configure() {
	...
	# Disable hwloc if USE flag is disabled... Experimental!
	if use hwloc; then
		myconf+=(
