...
# $Header: /var/cvsroot/gentoo-x86/x11-libs/qt-gui/qt-gui-4.7.4.ebuild,v 1.1 2011/09/08 09:20:08 wired Exp $
...
src_configure() {
	...
	# Disables NEON for ARM as it seems to be broken in many ways. Multiple
	# bugs regarding qt-gui's NEON support can be found.
	myconf="${myconf} -no-neon"
